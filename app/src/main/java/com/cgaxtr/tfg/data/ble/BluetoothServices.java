...
public class BluetoothServices {
    public static class Basic {
        ...
        public static UUID steps = UUID.fromString("00000007-0000-3512-2118-0009af100700");
        public static UUID activityData = UUID.fromString("0000ff07-0000-1000-8000-00805f9b34fb");
    }
